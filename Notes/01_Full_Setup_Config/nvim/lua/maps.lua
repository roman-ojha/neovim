...
-- Terminal
map("n", "<CA-b>", "<CMD>ToggleTerm size=40 direction=vertical<CR><C-\\><C-n>", { noremap = true })
-- Ctrl + Alt + b
map("n", "<CA-n>", "<CMD>ToggleTerm size=10 direction=horizontal<CR><C-\\><C-n>", { noremap = true })
